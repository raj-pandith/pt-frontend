    ...
    const steps = [
        {
            id: 1,
            title: "Pickup",
            desc: "Scheduled collection from your facility for a quick and hassle-free service.",
        ...
        },
        {
            ...
            desc: "Every garment is sorted and coded to ensure precise and accurate tracking.",
        ...
        },
        {
            id: 3,
            title: "Inspection",
            desc: "Items are checked for stains, fabric condition, and specific garment care.",
        ...
        },
        {
            id: 4,
            title: "Washing",
            desc: "Cleaned using RO water, eco-friendly detergents, and advanced machines.",
        ...
        },
        {
            id: 5,
            title: "Fabric Care",
            desc: "Extra care is taken to maintain the color, softness, and fabric durability.",
        ...
        },
        {
            ...
            desc: "Every item is carefully dried, steam pressed, or folded as per requirement.",
        ...
        },
        {
            id: 7,
            title: "Quality Check",
            desc: "Each batch is thoroughly inspected for perfection before being dispatched.",
        ...
        },
        {
            id: 8,
            title: "Delivery",
            desc: "Your items are securely packed and delivered back to you right on time.",
    ...
    return (
      ...
      */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-12 gap-y-12 md:gap-y-24 relative w-full">
                ...
                <div className="hidden md:block absolute top-1/2 left-[-48px] right-[-48px] border-t-[3px] border border-gray-900 -translate-y-[3px] z-0"></div>
                ...
                {steps.map((step, index) => (
                    <div key={step.id} className="relative z-10 w-full h-full flex flex-col items-center">
                        ...
                        {(index === 0 || index === 1 || index === 2 || index === 4 || index === 5 || index === 6) && (
                            <div className="hidden md:block absolute top-1/2 -right-[48px] w-[48px] border-t-[3px] border border-gray-900 -translate-y-1/2 z-0">
                        ...
                        {index === 3 && (
                            <div className="hidden md:block absolute top-1/2 -right-[48px] w-[48px] h-[calc(50%+48px)] border-t-[6px] border-r-[3px] border border-b-0 border-gray-900 rounded-tr-[24px] z-0 border-l-0"></div>
                        )}

                        {/* S-Curve Left Drop Connection (Comes up from middle span and points into Card 5) */}
                        {index === 4 && (
                            <div className="hidden md:block absolute -top-[48px] -left-[48px] w-[48px] h-[calc(50%+48px)] border-l-[6px] border-b-[3px] border-r-0 border border-t-0 border-gray-900 rounded-bl-[24px] z-0">
                                <div className="absolute right-0 -bottom-[12px]   w-0 h-0 border-t-[12px] border-t-transparent border-l-[18px] border-l-gray-900 border-b-[12px] border-b-transparent"></div>
                            </div>
                        )}
